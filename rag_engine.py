...
class RAGEngine:
    def __init__(self, db_path="geochat_data/vector_db", model_name="sentence-transformers/all-MiniLM-L6-v2", llm_model="phi3:mini"):
        ...
        print("  Connecting to VectorDB...", end="\r")
        self.client = chromadb.PersistentClient(path=self.db_path)
        self.collection = self.client.get_collection(name="geochat_docs")
        print("  Connecting to VectorDB... [OK]  ")
...
"""
    ...
    def answer(self, query, k=5):
        ...
        # Documents are clean (no prefixes with MiniLM)
        clean_docs = documents
        
        # 2. Build Prompt
        prompt = self.build_prompt(clean_docs, query)
...
if __name__ == "__main__":
    ...
    engine = RAGEngine()
    print("\nTest Answer:")
    print(engine.answer("What is the geology of the Himalayas?"))
